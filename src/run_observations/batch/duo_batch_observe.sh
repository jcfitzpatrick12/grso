...
bash src/shell_utils/create_dir.sh "temp_data_${tag_0}"
#create the temporary data folder if it does not exist
...
temp_path_0="${GRSOPARENTPATH}/temp_data_${tag_0}"
...
do
  ...
  python3 src/gr/batch/DuoBatchObserve.py $tag_0 $tag_1 &
